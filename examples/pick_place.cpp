...
int main(int argc, char **argv) {
    ...
    float GRASP_WIDTH, GRASP_FORCE, GRASP_EPSILON_INNER, GRASP_EPSILON_OUTER;
    float PRE_GRASP_APPROCH_X, PRE_GRASP_APPROCH_Y, PRE_GRASP_APPROCH_Z;
    float POST_GRASP_RETREAT_X, POST_GRASP_RETREAT_Y, POST_GRASP_RETREAT_Z;
    float POST_PLACE_RETREAT_X, POST_PLACE_RETREAT_Y, POST_PLACE_RETREAT_Z;
